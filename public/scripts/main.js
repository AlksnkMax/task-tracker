	...
	var ProjectList = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var projectNodes = this.props.data.map(function (project) {
	      return React.createElement(Project, { key: project._id, title: project.projectName, project: project });
	    });
	    return React.createElement(
	      'div',
	...
	var TaskList = React.createClass({
	  ...
	  render: function render() {
	    var taskNodes = this.props.data.map(function (task) {
	      return React.createElement(Task, { key: task._id, title: task.taskName, task: task });
	    });
	    return React.createElement(
	      'div',
	      { className: 'taskList' },
